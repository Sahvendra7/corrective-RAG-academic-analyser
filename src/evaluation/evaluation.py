...
def run_evaluation(mode="crag", judge_model="gemini-3.1-flash-lite"):
    ...
    if VERIFY_CSV:
        output_path = f"data/processed/evaluation_results_{mode}_{safe_file_name}_verify.csv"
    else: 
        output_path = f"data/processed/evaluation_results_{mode}_{safe_file_name}.csv"
