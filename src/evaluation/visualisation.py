...
def load_and_merge_data():
    crag_path  = "data/processed/evaluation_results_crag_gemini-3-1-flash-lite.csv"
    naive_path = "data/processed/evaluation_results_naive_gemini-3-1-flash-lite.csv"
...
def plot_dashboard(df):
    ...
    save_path = "data/plots/master_evaluation_dashboard.png"
